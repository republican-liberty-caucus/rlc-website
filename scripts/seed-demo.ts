...
async function deleteByDemoTag(table: string): Promise<number> {
  const { data, error } = await supabase
    ...
    .select('id');
  if (error) {
    // Table may not have metadata column — try alternate approach
...
async function teardown() {
  ...
  // Reverse FK order — deepest dependencies first
  const tables = [
    ...
    'rlc_charter_split_rules',
    'rlc_charter_split_configs',
    'rlc_charter_stripe_accounts',
  ...
  for (const table of tables) {
    const count = await deleteByDemoTag(table);
    if (count > 0) console.log(`  ${table}: ${count} rows deleted`);
  }

  // Remove Clerk demo users
  for (const email of ['demo-admin@rlc-demo.test', 'demo-member@rlc-demo.test']) {
...
async function seed() {
  ...
  const adminUser = await clerk.users.createUser({
    emailAddress: ['demo-admin@rlc-demo.test'],
  ...
  console.log(`  Admin: ${adminUser.id} (demo-admin@rlc-demo.test)`);

  const memberUser = await clerk.users.createUser({
    emailAddress: ['demo-member@rlc-demo.test'],
  ...
  console.log(`  Member: ${memberUser.id} (demo-member@rlc-demo.test)`);
  ...
  const charters = [
    {
      ...
      state_code: null,
      status: 'active',
      contact_email: 'national@rlc-demo.test',
    ...
    },
    {
      ...
      state_code: 'TX',
      status: 'active',
      contact_email: 'texas@rlc-demo.test',
    ...
    },
    {
      ...
      state_code: 'FL',
      status: 'active',
      contact_email: 'florida@rlc-demo.test',
    ...
    },
    {
      ...
      state_code: 'NH',
      status: 'active',
      contact_email: 'nh@rlc-demo.test',
    ...
    },
    {
      ...
      state_code: 'TX',
      status: 'active',
      contact_email: 'travis@rlc-demo.test',
    ...
    },
    {
      ...
      state_code: 'FL',
      status: 'active',
      contact_email: 'hillsborough@rlc-demo.test',
  ...
  const contacts = [
    // Admin user contact
    {
      ...
      email: 'demo-admin@rlc-demo.test',
      first_name: 'Sarah',
      last_name: 'Liberty',
      phone: '(512) 555-0100',
    ...
    // Member user contact
    {
      ...
      email: 'demo-member@rlc-demo.test',
      first_name: 'James',
      last_name: 'Freedom',
      phone: '(813) 555-0200',
    ...
    // Filler members (8)
    {
      ...
      first_name: 'Robert',
      last_name: 'Hamilton',
      email: 'demo-hamilton@rlc-demo.test',
      membership_tier: 'sustaining',
      membership_status: 'current',
      membership_start_date: '2023-03-10',
      membership_expiry_date: '2027-03-10',
      primary_charter_id: txStateId,
      city: 'Dallas',
      state: 'TX',
      metadata: DEMO_TAG,
    },
    {
      ...
      first_name: 'Emily',
      last_name: 'Madison',
      email: 'demo-madison@rlc-demo.test',
      membership_tier: 'premium',
      membership_status: 'current',
      membership_start_date: '2023-09-20',
      membership_expiry_date: '2026-09-20',
      primary_charter_id: flStateId,
      city: 'Miami',
      state: 'FL',
      metadata: DEMO_TAG,
    },
    {
      ...
      first_name: 'Thomas',
      last_name: 'Jefferson',
      email: 'demo-jefferson@rlc-demo.test',
      membership_tier: 'benefactor',
      membership_status: 'current',
      membership_start_date: '2021-07-04',
      membership_expiry_date: '2027-07-04',
      primary_charter_id: nhStateId,
      city: 'Concord',
      state: 'NH',
      metadata: DEMO_TAG,
    },
    ...
    },
    {
      ...
      first_name: 'Benjamin',
      last_name: 'Franklin',
      email: 'demo-franklin@rlc-demo.test',
      membership_tier: 'roundtable',
      membership_status: 'current',
      membership_start_date: '2020-11-03',
      membership_expiry_date: '2028-11-03',
      primary_charter_id: nationalId,
      city: 'Philadelphia',
      state: 'PA',
      metadata: DEMO_TAG,
    },
    {
      ...
      email: 'demo-washington@rlc-demo.test',
      membership_tier: 'student_military',
      membership_status: 'current',
      membership_start_date: '2025-09-01',
      membership_expiry_date: '2026-09-01',
      primary_charter_id: flCountyId,
      city: 'Tampa',
      state: 'FL',
      // Household member with James Freedom
      household_id: householdId,
      household_role: 'spouse',
      primary_contact_id: memberContactId,
      metadata: DEMO_TAG,
    },
    {
      id: id(),
      ...
      last_name: 'Hamilton',
      email: 'demo-a-hamilton@rlc-demo.test',
      membership_tier: 'individual',
  ...
  // Memberships for the 2 main users
  ...
  const events = [
    {
      id: event1Id,
      title: 'RLC National Convention 2026',
      slug: 'demo-national-convention-2026',
      description:
        'Annual gathering of liberty-minded Republicans from across the nation. Keynote speakers, workshops, and networking.',
      ...
      charter_id: nationalId,
      organizer_id: adminContactId,
      status: 'published',
      metadata: DEMO_TAG,
    },
    {
      id: event2Id,
      title: 'Florida Liberty Mixer',
      slug: 'demo-florida-liberty-mixer',
      ...
      registration_fee: 0,
      charter_id: flStateId,
      organizer_id: memberContactId,
      status: 'published',
      metadata: DEMO_TAG,
    },
    {
      id: event3Id,
      title: 'Virtual Town Hall: 2026 Legislative Priorities',
      slug: 'demo-virtual-town-hall-2026',
      description:
        'Join us online to discuss key bills and legislative strategies for the 2026 session.',
      event_type: 'town_hall',
      start_date: '2026-03-10T19:00:00Z',
      end_date: '2026-03-10T20:30:00Z',
      is_virtual: true,
      virtual_url: 'https://zoom.us/j/demo-placeholder',
      registration_required: true,
      charter_id: nationalId,
      status: 'published',
      metadata: DEMO_TAG,
  ...
  for (const e of events) {
    await insert('rlc_events', e);
  }

  // 4 registrations across events
  const registrations = [
    {
      id: id(),
      event_id: event1Id,
  ...
  for (const r of registrations) {
    await insert('rlc_event_registrations', r);
  }
  console.log(`  ${events.length} events + ${registrations.length} registrations created`);
  ...
  const contributions = [
    ...
    },
    {
      id: id(),
      contact_id: adminContactId,
      contribution_type: 'event_registration',
      amount: 150.0,
      payment_status: 'completed',
      charter_id: nationalId,
      source: 'demo-seed',
  ...
  for (const c of contributions) {
    await insert('rlc_contributions', c);
  }
  ...
  const posts = [
    {
      id: id(),
      title: 'RLC Announces 2026 Convention in Austin',
      slug: 'demo-rlc-2026-convention-announcement',
      content:
        '<p>The Republican Liberty Caucus is excited to announce that our 2026 National Convention will be held at the Austin Convention Center in Austin, Texas, from July 15-17.</p><p>This year\'s theme, "Liberty Ascending," will feature keynote addresses from leading voices in the liberty movement, policy workshops on Second Amendment rights, fiscal responsibility, and criminal justice reform, and networking opportunities with liberty-minded Republicans from all 50 states.</p><p>Early bird registration is now open. Don\'t miss this opportunity to shape the future of the Republican Party.</p>',
      excerpt:
        'Join us in Austin, TX for the 2026 RLC National Convention — "Liberty Ascending."',
      author_id: adminContactId,
      charter_id: nationalId,
      status: 'published',
      content_type: 'post',
      published_at: '2026-01-15T12:00:00Z',
      categories: ['Events', 'National'],
      tags: ['convention', '2026', 'austin'],
      metadata: DEMO_TAG,
    },
    {
      id: id(),
      title: 'Liberty Scorecard: How Your Representatives Voted',
      slug: 'demo-liberty-scorecard-update',
      content:
        '<p>Our latest Liberty Scorecard update shows how your federal representatives voted on key liberty issues during the current congressional session.</p><p>The scorecard tracks votes on bills related to fiscal responsibility, individual rights, limited government, and free markets. Each legislator receives a liberty score based on their alignment with pro-liberty positions.</p><p>Visit our Scorecards page to see how your representatives stack up.</p>',
      excerpt:
        'Check how your federal representatives scored on key liberty votes this session.',
      author_id: adminContactId,
      charter_id: nationalId,
      status: 'published',
      content_type: 'post',
      published_at: '2026-02-01T10:00:00Z',
      categories: ['Scorecards', 'Advocacy'],
      tags: ['scorecard', 'congress', 'voting-record'],
      metadata: DEMO_TAG,
    },
    {
      id: id(),
      title: 'Upcoming State Legislative Priorities for 2026',
      slug: 'demo-state-legislative-priorities',
      content:
        '<p>Draft: This post will outline the key state-level legislative priorities for 2026 across our state chapters.</p><p>Topics will include property tax reform, occupational licensing, education freedom, and Second Amendment protection.</p>',
      excerpt: 'A look at key state-level legislative priorities for 2026.',
      author_id: adminContactId,
      status: 'draft',
      content_type: 'post',
      categories: ['Legislation'],
      tags: ['state-issues', '2026'],
      metadata: DEMO_TAG,
    },
  ];

  for (const p of posts) {
    await insert('rlc_posts', p);
  }
  console.log(`  ${posts.length} posts created (2 published, 1 draft)`);
  ...
  if (existingSessions && existingSessions.length > 0) {
    ...
    await insert('rlc_scorecard_sessions', {
      id: demoSessionId,
      name: 'Demo: 119th Congress (House)',
      slug: 'demo-119th-congress-house',
    ...
    await insert('rlc_scorecard_bills', {
      ...
      bill_number: 'H.R. 0001',
      title: 'Federal Spending Transparency Act',
      liberty_position: 'yea',
      category: 'fiscal',
      weight: 1.0,
      sort_order: 1,
      bill_status: 'voted',
    ...
    await insert('rlc_scorecard_bills', {
      id: bill2Id,
      session_id: demoSessionId,
      bill_number: 'H.R. 0002',
      title: 'Online Surveillance Expansion Act',
      liberty_position: 'nay',
    ...
    const legs = [
      {
        id: legIds[0],
        name: 'Rep. Jane Constitutionalist',
        party: 'R',
        chamber: 'us_house',
        state_code: 'TX',
        district: 'TX-10',
    ...
    for (const l of legs) {
      await insert('rlc_legislators', l);
    }

    // Votes
    const votes = [
      // Constitutionalist: yea on bill1 (aligned), nay on bill2 (aligned)
      ...
      // Moderate: yea on bill1 (aligned), yea on bill2 (not aligned)
      ...
      // Statist: nay on bill1 (not aligned), yea on bill2 (not aligned)
    ...
    for (const v of votes) {
      await insert('rlc_scorecard_votes', v);
    }
    ...
    for (let i = 0; i < legIds.length; i++) {
      ...
      await insert('rlc_scorecard_legislator_scores', {
        id: id(),
        session_id: demoSessionId,
        legislator_id: legIds[i],
        votes_aligned: aligned,
        total_bills: 2,
        absences: 0,
        bonus_points: 0,
  ...
  await insert('rlc_surveys', {
    id: surveyId,
    title: 'Demo: 2026 Primary Candidate Survey',
    slug: 'demo-2026-primary-survey',
    description:
      'Candidate endorsement survey for the 2026 Republican primary elections.',
    status: 'active',
    election_type: 'primary',
    election_date: '2026-03-03',
    state: 'TX',
    charter_id: txStateId,
    created_by: adminContactId,
    metadata: DEMO_TAG,
  });
  ...
  const questions = [
    {
      question_text: 'Do you support a balanced budget amendment to the U.S. Constitution?',
    ...
    {
      question_text:
        'On a scale of 1-10, how strongly do you support reducing federal regulations on small businesses?',
      question_type: 'scale',
      options: [],
      weight: 1.5,
      sort_order: 2,
    ...
    {
      question_text: 'Which of the following best describes your position on the Second Amendment?',
      question_type: 'multiple_choice',
      options: [
        'Absolute right — no infringements',
        'Support with reasonable restrictions',
        'Support current regulations',
        'Support additional restrictions',
      ],
      weight: 2.0,
      sort_order: 3,
      ideal_answer: 'Absolute right — no infringements',
    },
    {
      question_text:
        'What specific steps would you take to reduce government spending in your first term?',
      question_type: 'text',
      options: [],
      weight: 1.0,
      sort_order: 4,
    ...
    {
      question_text:
        'Do you support eliminating the federal Department of Education?',
      question_type: 'yes_no',
      options: [],
      weight: 1.0,
      sort_order: 5,
  ...
  for (const q of questions) {
    ...
    await insert('rlc_survey_questions', {
      id: qId,
      survey_id: surveyId,
      ...q,
    });
  ...
  await insert('rlc_candidate_responses', {
    id: candidate1Id,
    survey_id: surveyId,
    candidate_name: 'John Libertarian',
    candidate_email: 'demo-libertarian@rlc-demo.test',
    candidate_party: 'Republican',
    candidate_office: 'State Representative',
    candidate_district: 'TX HD-47',
  ...
  await insert('rlc_candidate_responses', {
    id: candidate2Id,
    survey_id: surveyId,
    candidate_name: 'Jane Conservative',
    candidate_email: 'demo-conservative@rlc-demo.test',
    candidate_party: 'Republican',
    candidate_office: 'State Representative',
    candidate_district: 'TX HD-47',
    access_token: crypto.randomBytes(16).toString('hex'),
  ...
  // Sample answers for candidate 1
  ...
  for (let i = 0; i < questionIds.length; i++) {
    await insert('rlc_survey_answers', {
      id: id(),
      candidate_response_id: candidate1Id,
      question_id: questionIds[i],
      answer: candidate1Answers[i],
      score: i === 3 ? null : 10.0, // text questions aren't auto-scored
    });
  }
  ...
  for (const s of sections) {
    ...
    await insert('rlc_candidate_vetting_report_sections', {
      ...
      data: s.section === 'executive_summary'
        ? {
            summary: 'John Libertarian is a strong liberty candidate with a consistent record of supporting limited government and individual rights.',
            recommendation: 'Recommend endorsement pending full background review.',
          }
        : {},
      metadata: DEMO_TAG,
    });

    // Assign the chair to the first section
  ...
  await insert('rlc_action_campaigns', {
    id: campaignId,
    title: 'Support the Spending Transparency Act',
    slug: 'demo-support-spending-transparency',
    description:
      'Contact your representative and urge them to vote YES on H.R. 0001, the Federal Spending Transparency Act.',
  ...
  await insert('rlc_charter_stripe_accounts', {
    id: stripeAccountId,
    charter_id: txStateId,
    stripe_account_id: 'acct_demo_tx_placeholder',
    status: 'active',
  ...
  await insert('rlc_charter_split_configs', {
    id: splitConfigId,
    charter_id: nationalId,
    disbursement_model: 'national_managed',
    is_active: true,
    updated_by_id: adminContactId,
    metadata: DEMO_TAG,
  });

  // Split rules: 60% national, 30% state, 10% county
  await insert('rlc_charter_split_rules', {
    id: id(),
    config_id: splitConfigId,
    recipient_charter_id: nationalId,
    percentage: 60.0,
    sort_order: 1,
    is_active: true,
    metadata: DEMO_TAG,
  ...
  await insert('rlc_charter_split_rules', {
    id: id(),
    config_id: splitConfigId,
    recipient_charter_id: txStateId,
    percentage: 30.0,
    sort_order: 2,
    is_active: true,
    metadata: DEMO_TAG,
  ...
  await insert('rlc_charter_split_rules', {
    id: id(),
    config_id: splitConfigId,
    recipient_charter_id: txCountyId,
    percentage: 10.0,
    sort_order: 3,
    is_active: true,
    metadata: DEMO_TAG,
  ...
  // 3 ledger entries
  // Grab a membership contribution ID for FK reference
  const { data: membershipContrib } = await supabase
  ...
  if (membershipContrib) {
    const ledgerEntries = [
      {
        id: id(),
        contribution_id: membershipContrib.id,
        source_type: 'membership',
        recipient_charter_id: nationalId,
        amount: 300.0,
        status: 'transferred',
        transferred_at: '2026-01-20T12:00:00Z',
        split_rule_snapshot: { percentage: 60, charter: 'National' },
        metadata: DEMO_TAG,
      },
      {
        id: id(),
        ...
        status: 'transferred',
        transferred_at: '2026-01-20T12:00:00Z',
        split_rule_snapshot: { percentage: 30, charter: 'Texas' },
        metadata: DEMO_TAG,
      },
      {
        id: id(),
        ...
        amount: 50.0,
        status: 'pending',
        split_rule_snapshot: { percentage: 10, charter: 'Travis County' },
        metadata: DEMO_TAG,
      },
    ];

    for (const le of ledgerEntries) {
      await insert('rlc_split_ledger_entries', le);
    }
    console.log('  1 Stripe account, 1 split config, 3 rules, 3 ledger entries created');
  } else {
    console.log('  1 Stripe account, 1 split config, 3 rules created (no ledger — contribution not found)');
  }
  ...
  // ------------------------------------------------------------------
  console.log('\n=== Seed Complete ===');
  console.log(`  Admin login:  demo-admin@rlc-demo.test  / ${ADMIN_PASSWORD}`);
  console.log(`  Member login: demo-member@rlc-demo.test / ${MEMBER_PASSWORD}`);
  console.log('  All records tagged with { is_demo: true } for clean teardown.\n');
}
